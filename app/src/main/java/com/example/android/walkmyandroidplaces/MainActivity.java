...
public class MainActivity extends AppCompatActivity implements FetchAddressTask.OnTaskCompleted {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mLocationCallback =
        new LocationCallback() {
          /**
           * This is the callback that is triggered when the FusedLocationClient updates your
           * location.
           *
  ...
  /**
   * Starts tracking the device. Checks for permissions, and requests them if they aren't present.
   * If they are, requests periodic location updates, sets a loading text and starts the animation.
   */
  ...
  /**
   * Stops tracking the device. Removes the location updates, stops the animation, and resets the
   * UI.
   */
